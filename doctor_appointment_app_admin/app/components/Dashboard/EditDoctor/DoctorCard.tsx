...
export default function DoctorCard({ doctor, onEdit, isRemoveMode = false }: DoctorCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className={styles.cardFooter}>
        <button 
          onClick={onEdit}
          className={`${styles.editButton} ${isRemoveMode ? styles.removeButton : ''}`}
        >
          {isRemoveMode ? 'Remove Doctor' : 'Edit Doctor'}
        </button>
